...
local function transProcFlag(t,id)
if type(t) == "table" then
local wlanCommFunc = require "modules.wlan_common_func"
local ssidFilter = wlanCommFunc.getSSIDNameFilter()
if string.find(t.VendorClassID,"SSID") ~= nil and ssidFilter(t.VendorClassID) == false then
return false
end
